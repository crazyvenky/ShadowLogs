...
ShadowLog is a lightweight background session recorder for the terminal. It creates a human-readable paper trail of every command run, organized by individual sessions.
